...
class PasswordStrength {
  ...
  static PasswordStrength empty() {
    return PasswordStrength('', Colors.white.withOpacityValue(0.5), 0.0, []);
  }
}
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            color: const Color(0xFFF8FAFC).withOpacityValue(0.8),
        ...
        //             border: Border.all(
        //               color: req.isMet ? color : Colors.white.withOpacityValue(0.1),
        //               width: 1,
        //             ),
        //           ),
        //           child: Row(
        ...
        //                 size: 14,
        //                 color:
        //                     req.isMet ? color : Colors.white.withOpacityValue(0.5),
        //               ),
